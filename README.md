...
- `modules/`: This folder contains modular functionalities of the project. Each module corresponds to a specific area of functionality and is organized into separate files. These modules can be utilized in cmd folder.

- `functions/`:This folder houses reusable functions used throughout the project. These functions are designed to be imported and used in modules folder
...
3. Go to your project location and type
   ```bash
   npm start
   ```
